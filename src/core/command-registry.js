const COMMAND_GROUPS = [
  {
    ...
    actions: [
      ...
      {
        action: "app.web_console",
        summary: "Start the local web console for runtime and bridge parameters",
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        summary: "Adjust the minimum short-chunk merge size for chat replies",
        terminal: [],
        weixin: ["/chunk <number>"],
        status: "active",
      },
      {
        ...
        summary: "Save a confirmed long-term memory",
        terminal: [],
        weixin: ["/remember <text>"],
        status: "active",
      },
      {
        action: "memory.manage",
        summary: "List, approve, or reject long-term memory candidates",
        terminal: [],
        weixin: ["/memory", "/memory approve <id>", "/memory reject <id>"],
        status: "active",
      },
      {
        action: "memory.forget",
        summary: "Archive a long-term memory by id",
        terminal: [],
        weixin: ["/forget <id>"],
        status: "active",
      },
...
function buildTerminalHelpText() {
  const lines = [
    ...
    "  cyberboss web-console  start the local control panel",
...
function actionEmoji(action) {
  switch (action.action) {
    ...
    case "memory.remember": return "🧠";
    case "memory.manage": return "🗂️";
    case "memory.forget": return "🗑️";
