...
function readConfig() {
  ...
  return {
    ...
    androidV2StateFile: path.join(stateDir, "android-edge-runtime-v2.json"),
    androidPublicBaseUrl: readTextEnv("HEART_ANCHOR_ANDROID_PUBLIC_BASE_URL"),
    androidV2AllowInsecureHttp: readOptionalBoolEnv("HEART_ANCHOR_ANDROID_V2_ALLOW_INSECURE_HTTP") ?? false,
